...
export interface GroupsRepository {
  ...
  addLead: (groupId: number, leadId: number) => Promise<Group>; //Adicionado para GroupLeadsController
  removeLead: (groupId: number, leadId: number) => Promise<Group>; //Adicionado para GroupLeadsController
}
